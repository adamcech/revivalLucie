...
/**
 * @param nazev Warning to alert
 * @param id submits given form by selected id
 */
function opravdu_smazat(nazev, id) {
    if (confirm(nazev)) {
...
/**
 * Uses attr "form-id", on click on selected elements to submit given form
 */
...
function remove_diacritic(stringWithDiacritics)
{
    var diacriticsMap = [
    ...
    for(var i=0; i<diacriticsMap.length; i++) {
        stringWithDiacritics = stringWithDiacritics.replace(diacriticsMap[i].letters, diacriticsMap[i].base);
    }
