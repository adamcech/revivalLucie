    ...
    */
    ...
    public function generateHtml() {
        ...
        if ($results->numRows == 0) {
            ...
            $code .= "<div class='table_image_view'>";
            $code .= "<div class='tr'><div class='th'>Název</div><div class='th'></div><div class='th'></div><div class='th'></div><div class='th'></div></div>";
            ...
            for ($i = 0; $i < count($results->results); $i++) {
                ...
                $code .= "<div class='file_item'>";

                $code .= "<a class='item_box' href='".$this->sectionUrl.$result->id."/'>";
                $code .= "<span class='helper'></span>";
                $code .= "<img src='".$result->getPathToImageThumb()."' alt='".$result->getShortName()."'>";
                $code .= "</a>";
                $code .= "</div>";
